...
_opc_(0xCFF4, OP_TIMEMS,     "TIMEMS",  op_timems,  OPCODE_BYTE,         -1)
_opc_(0xCFF5, OP_SECURE_SERVER_SOCKET,     "SRVRSECSKT",     op_illegal2,  OPCODE_BYTE,         -1)
_opc_(0xCFF6, OP_SECURE_ACCEPT_SOCKET,     "ACCPTSECSKT",     op_illegal2,  OPCODE_BYTE,         -1)
_opc_(0xCFF7, OP_SECURE_READ_SOCKET,     "READSECSKT",     op_illegal2,  OPCODE_BYTE,         -1)
_opc_(0xCFF8, OP_SECURE_WRITE_SOCKET,     "WRITESECSKT",     op_illegal2,  OPCODE_BYTE,         -1)
_opc_(0xCFF9, OP_SECURE_CLOSE_SOCKET,     "CLOSESECSKT",     op_illegal2,  OPCODE_BYTE,         -1)
_opc_(0xCFFA, OP_HASHMAP_INIT,     "HASHMAP.INIT",     op_hashmap_init,  OPCODE_BYTE,         -1)
_opc_(0xCFFB, OP_HASHMAP_PUT,     "HASHMAP.PUT",     op_hashmap_put,  OPCODE_BYTE,         -1)
_opc_(0xCFFC, OP_HASHMAP.GET,     "HASHMAP.GET",     op_hashmap_get,  OPCODE_BYTE,         -1)
